            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Bağış Ekle</h1>
                        
                    </div>
<center>
        <div style="color:black;">
            <form method="POST" action="bagisekleislem.php">
                ...
                <div class="col-xl-4 col-md-6 mb-4">
                    <label class="form-label" for="form6Example5"><b>Bağışladığı Para</b></label>
                    <input type="text" id="form6Example5" class="form-control" name="bagis" />
                </div>

                <div class="col-xl-4 col-md-6 mb-4">
                    <button type="submit" class="btn btn-primary btn-block mb-4">Bağışçı Ekle</button>
                </div>
            </form>
        </div>
</center>
