...
class PDF extends FPDF
{
	...
	function Header()
	{
		...
		$this->Cell(130);
		$this->Cell(30,10,'BURS ALANLAR TASLAK',0,1,'C');
   ...
   function MainTable()
   {
	...
	$this->Cell(20,6,"$satir[bursfiyat] TL",1,1,'C');
	}
	...
	$this->Setfont('courier','B',10);
   	...
   	$this->Cell(40,6,'',1,0,'C');
   	$this->Cell(90,6,'TOPLAM BURS',1,0,'C');
	$this->Cell(20,6,"$toplamburs TL",1,1,'C');
   }
